...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */function B(t){if(null===t||"[object Object]"!==function(t){return Object.prototype.toString.call(t)}(t))return!1;var e=Object.getPrototypeOf(t);return null===e||e===Object.prototype}function Q(t){return void 0===t}function Z(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];if(0===t.length)return Object.create(null);var r=Object.create(null);function n(t,e){B(r[e])&&B(t)?r[e]=Z(r[e],t):B(t)?r[e]=Z({},t):Array.isArray(t)?r[e]=Z(t):r[e]=t}return r=Array.isArray(t[0])?[]:Object.create(null),t.forEach((function(t){et(t,n)})),r}function et(t,e){if(null!=t){var r=t;"object"!=typeof t&&(r=[t]),Array.isArray(r)?r.forEach((function(r,n){e.call(null,r,n,t)})):Object.keys(r).forEach((function(t){e.call(null,r[t],t,r)}))}}function rt(){if(!Q(wx)||!Q(my))return function(){if(!Q(wx))return wx;if(!Q(my))return my;if(!Q(swan))return swan;if(!Q(tt))return tt;throw new TypeError("Unrecognized Platform")}().request;throw new TypeError("Unrecognized Platform")}function nt(t){function e(t){if("string"!=typeof t)return t;try{return JSON.parse(t)}catch(e){return t}}function r(t){var e=Z({},t);return e.headers=t.header,delete e.header,delete e.Adapter,e}return new Promise((function(n,o){var i=t.Adapter,a=function(t){return Q(wx)?Q(my)?t:function(t){var e={url:t.url||"",method:t.method,data:t.data,headers:t.headers,dataType:"json",timeout:t.timeout},r=t.dataType||"json";return e.dataType=r,t.responseType&&"json"!==t.responseType&&(e.dataType="其他"),e}(t):function(t){var e={url:t.url||"",method:t.method,data:t.data,header:t.headers,dataType:"json",timeout:t.timeout},r=t.dataType||"json";return e.dataType=r,t.responseType&&"json"!==t.responseType&&(e.dataType="其他"),e}(t)}(t),s=r(t);if(!i)throw new TypeError("Adapter is undefined or null");var u=new i(s),c=rt()($($({},a),{success:function(t){u.resolve(function(t){return Q(t)||null===t?{headers:{},status:200,data:{},response:t}:{headers:t.header,status:t.statusCode,data:e(t.data),response:t}}(t),n)},fail:function(t){var e=function(t,e){return t&&(t.errMsg||"").toString().toLowerCase().includes("timeout")?{msg:"Timeout of "+(e||"")+" ms exceeded",type:"TIMEOUT"}:{msg:"Network Error",type:"NETWORK_ERROR"}}(t,a.timeout),r={errMsg:e.msg,status:e.type,extra:t};u.reject(r,o)},complete:function(){c=null}}));u.subscribeCancelEvent((function(t){o(t),c.abort(),c=null})),"function"==typeof t.getRequestTask&&t.getRequestTask(nt)}))}function ot(t){return nt(t)}function it(t){if(null===t||"[object Object]"!==function(t){return Object.prototype.toString.call(t)}(t))return!1;var e=Object.getPrototypeOf(t);return null===e||e===Object.prototype}function at(t,e){if(null!=t){var r=t;"object"!=typeof t&&(r=[t]),Array.isArray(r)?r.forEach((function(r,n){e.call(null,r,n,t)})):Object.keys(r).forEach((function(t){e.call(null,r[t],t,r)}))}}function st(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];if(0===t.length)return Object.create(null);var r=Object.create(null);function n(t,e){it(r[e])&&it(t)?r[e]=st(r[e],t):it(t)?r[e]=st({},t):Array.isArray(t)?r[e]=st(t):r[e]=t}return r=Array.isArray(t[0])?[]:Object.create(null),t.forEach((function(t){at(t,n)})),r}Y.defaults.adapter=ot;var ut=function(){function t(t,e){this.hadRetry=0,this.retryTimes=2,this.interval=2e3,this.baseURL="",this.url="",this.fnName="",this.method="GET";var r=t.retryTimes,n=t.interval;this.baseURL=t.baseURL,this.url=t.url,this.fnName=t.fnName,this.method=t.method||this.method,this.retryTimes=this.getValidNumber(this.retryTimes,r),this.interval=this.getValidNumber(this.interval,n),this.appletsRequest=e}return t.prototype.getValidNumber=function(t,e){return e||0===e?e:t},t.prototype.http=function(t){var r=this;return new Promise((function(n,o){r.request(e(e({},t||{}),{url:r.url,method:r.method}),n,o)}))},t.prototype.request=function(t,e,r){var n=this;Promise.resolve(t).then((function(t){return n.appletsRequest(t)})).then((function(t){n.hadRetry=0,e(t)})).catch((function(o){if(n.isRetryError(o)&&n.hadRetry<n.retryTimes){n.hadRetry+=1;var i=st(t,o.options||{});n.request(i,e,r)}else n.isIntervalRetryError(o)&&n.hadRetry<n.retryTimes?setTimeout((function(){n.hadRetry+=1,n.request(t,e,r)}),n.interval):r(n.isRetryError(o)?o.originalErr:o)}))},t.prototype.isRetryError=function(t){return!!t&&"RETRY_ERROR"===t.errCode},t.prototype.isIntervalRetryError=function(t){return!!t&&("NETWORK_ERROR"===t.status||"TIMEOUT"===t.status)},t}(),ct=function(){function t(t,r){var n;this.apiList={},this.apis=Object.create(null),this.baseURL=t.baseURL,this.appletsRequest=Y.create(e(e({},st(((n=R()).adapter=ot,n),r||{})),{baseURL:this.baseURL})),this.createApiItem(t.apiList)}return t.prototype.createApiItem=function(t){if(n=t,Array.isArray(n)){var e=Object.create(null);t.forEach((function(t){t.fnName&&(e[t.fnName]=t)}));var r=t.map((function(t){return t.fnName}));return this.apiList=e,void this.generateApiFn(r)}var n;if(it(t)){this.apiList=t;r=Object.keys(t);this.generateApiFn(r)}},t.prototype.generateApiFn=function(t){var r=this;t.forEach((function(t){var n=r.apiList[t],o={baseURL:r.baseURL,fnName:t,method:n.method,url:n.apiUrl,interval:n.interval,retryTimes:n.retryTimes};if("function"==typeof r.apis[t])throw new Error(t+" already exists in apiList");r.apis[t]=function(t){var i=new ut(o,r.appletsRequest),a=e(e({},t||{}),{apiConfig:n});return i.http(a)},r.apis[t]=function(t,e){if("string"==typeof e)return t;for(var r in e)t[r]=e[r];return t}(r.apis[t],o)}))},t.prototype.addApiList=function(t){this.createApiItem(t)},t.prototype.createRetryError=function(t,e){return{errCode:"RETRY_ERROR",originalErr:t,options:e}},t.prototype.addRequestInterceptor=function(t,e){this.appletsRequest.interceptors.request.use(t,e)},t.prototype.addResponseInterceptor=function(t,e){this.appletsRequest.interceptors.response.use(t,e)},t.prototype.createCancelToken=function(){return new this.appletsRequest.CancelToken},t.prototype.transformConfig=function(t){this.appletsRequest.defaults.transformConfig=t},t}();t.default=ct,Object.defineProperty(t,"__esModule",{value:!0})}));//# sourceMappingURL=applets-request-mode-list.min.js.map
